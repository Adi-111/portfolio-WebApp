...
export const content = {
  ...
  hero: {
    ...
    heroContent: [
      ...
      {
        count: "5",
        text: "Projects Worked in my career --Personal",
      },
    ] as HeroContent[],
  } as HeroData,
  skills: {
  ...
  contact: {
    ...
    socialMedia: [
      {
        text: "chandradityasingh@gmail.com",
        icon: GrMail,
        link: "chandradityasingh11@gmail.com",
      },
      {
        text: "+91 9649659090",
        icon: MdCall,
        link: "https://wa.me/9649659090",
      },
      {
        text: "codeaprogram",
        icon: BsInstagram,
